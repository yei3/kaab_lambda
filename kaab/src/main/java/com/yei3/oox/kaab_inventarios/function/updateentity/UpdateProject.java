...
public class UpdateProject implements RequestStreamHandler {

    @Override
    public void handleRequest(InputStream input, OutputStream output, Context context) throws IOException {
    	LambdaLogger logger = context.getLogger();
        logger.log("Updateproject starting");
        ...
        try {
        	...
        	Project project = (Project)h.getItemById(Project.class, toIntExact((long)body.get("id")));
        	...
        	if (project != null) {
            	...
            	//TODO add cognito >:v
            	project.setLastModUserID(toIntExact((long)body.get("userId")));
            	project.setLastModDateTime(new Timestamp(System.currentTimeMillis()));

            	h.updateItem(Project.class, project);
