...
public class GetAccountingAccountById implements RequestStreamHandler {

    @Override
    public void handleRequest(InputStream input, OutputStream output, Context context) throws IOException {
    	LambdaLogger logger = context.getLogger();
        logger.log("Getaccountingaccountbyid starting");
        ...
        try {
        	...
        	if (event.get("queryStringParameters") != null) {
                ...
                if ( pps.get("id") != null) {
                	...
                	AccountingAccount accountingAccount = (AccountingAccount)h.getItemById(AccountingAccount.class,Integer.parseInt((String) pps.get("id")));
                	
                	 if (accountingAccount != null) {
                		 JSONObject accountingAccountJson = new JSONObject();
                        ...
                        responseBody.put("accountingAccount", accountingAccountJson);
                	 }else {
                		 errorCode.put("errorCode", 1);
                         errorCode.put("message", "The accounting account corresponding to id = " + pps.get("id") + " does not exists.");
                	 }
