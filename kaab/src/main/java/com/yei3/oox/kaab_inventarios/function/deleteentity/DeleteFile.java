...
public class DeleteFile implements RequestStreamHandler {

    @Override
    public void handleRequest(InputStream input, OutputStream output, Context context) throws IOException {
    	LambdaLogger logger = context.getLogger();
        logger.log("Deletefile starting");
        ...
        try {
        	...
        	File file = (File)h.getItemById(File.class, toIntExact((long)body.get("id")));
        	...
        	if (file != null) {
            	...
            	if (user != null) {
            		file.setDeleteUserID(toIntExact((long)body.get("userId")));
            		file.setDeleteDateTime(new Timestamp(System.currentTimeMillis()));
                	h.updateItem(File.class, file);
