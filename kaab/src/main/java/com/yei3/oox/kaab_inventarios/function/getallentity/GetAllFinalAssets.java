...
public class GetAllFinalAssets implements RequestStreamHandler {

    @Override
    public void handleRequest(InputStream input, OutputStream output, Context context) throws IOException {
    	LambdaLogger logger = context.getLogger();
        logger.log("Getallfinalassets starting");
        ...
        try {
        	...
        	List<Object> finalAssets = (List<Object>)h.getAllEntity(FinalAsset.class);
