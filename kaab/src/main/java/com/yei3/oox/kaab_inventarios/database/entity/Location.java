...
public class Location implements Entity{
	...
	public String toString() {
		return "Location [id=" + id + ", locationType=" + locationType + ", locationID=" + locationID + ", name=" + name
	...
	public Location(String locationType, int locationID, String name, int statusID) {
