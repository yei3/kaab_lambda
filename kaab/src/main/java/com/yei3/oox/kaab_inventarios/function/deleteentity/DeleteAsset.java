...
public class DeleteAsset implements RequestStreamHandler {

    @Override
    public void handleRequest(InputStream input, OutputStream output, Context context) throws IOException {
    	LambdaLogger logger = context.getLogger();
        logger.log("Deleteasset starting");
        ...
        try {
        	...
        	if (asset != null) {
            	...
            	if (user != null) {
            		asset.setDeleteUserID(toIntExact((long)body.get("userId")));
                	asset.setDeleteDateTime(new Timestamp(System.currentTimeMillis()));
