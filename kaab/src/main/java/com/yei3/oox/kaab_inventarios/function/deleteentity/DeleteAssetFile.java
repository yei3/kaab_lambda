...
public class DeleteAssetFile implements RequestStreamHandler {

    @Override
    public void handleRequest(InputStream input, OutputStream output, Context context) throws IOException {
    	LambdaLogger logger = context.getLogger();
        logger.log("Deleteassetfile starting");
        ...
        try {
        	...
        	AssetFile asset = (AssetFile)h.getItemById(AssetFile.class, toIntExact((long)body.get("id")));
        	...
        	if (asset != null) {
            	...
            	if (user != null) {
                	...
                	h.updateItem(AssetFile.class, asset);
