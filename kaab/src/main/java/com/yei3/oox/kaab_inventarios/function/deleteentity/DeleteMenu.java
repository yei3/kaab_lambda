...
public class DeleteMenu implements RequestStreamHandler {

    @Override
    public void handleRequest(InputStream input, OutputStream output, Context context) throws IOException {
    	LambdaLogger logger = context.getLogger();
        logger.log("Deletemenu starting");
        ...
        try {
        	...
        	if (menu != null) {
            	...
            	if (user != null) {
            		menu.setDeleteUserID(toIntExact((long)body.get("userId")));
            		menu.setDeleteDateTime(new Timestamp(System.currentTimeMillis()));
