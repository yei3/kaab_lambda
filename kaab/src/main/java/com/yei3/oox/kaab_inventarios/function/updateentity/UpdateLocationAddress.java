...
public class UpdateLocationAddress implements RequestStreamHandler {

    @Override
    public void handleRequest(InputStream input, OutputStream output, Context context) throws IOException {
    	LambdaLogger logger = context.getLogger();
        logger.log("UpdatelocationAddress starting");
        ...
        try {
        	...
        	if (locationAddress != null) {
            	...
            	//TODO add cognito >:v
            	locationAddress.setLastModUserID(toIntExact((long)body.get("userId")));
            	locationAddress.setLastModDateTime(new Timestamp(System.currentTimeMillis()));
