...
public class UpdateRegistrationSession implements RequestStreamHandler {

    @Override
    public void handleRequest(InputStream input, OutputStream output, Context context) throws IOException {
    	LambdaLogger logger = context.getLogger();
        logger.log("UpdateregistrationSession starting");
        ...
        try {
        	...
        	RegistrationSession registrationSession = (RegistrationSession)h.getItemById(RegistrationSession.class, toIntExact((long)body.get("id")));
        	...
        	if (registrationSession != null) {
            	...
            	//TODO add cognito >:v
            	registrationSession.setLastModUserID(toIntExact((long)body.get("userId")));
            	registrationSession.setLastModDateTime(new Timestamp(System.currentTimeMillis()));
            	
            	h.updateItem(RegistrationSession.class, registrationSession);
