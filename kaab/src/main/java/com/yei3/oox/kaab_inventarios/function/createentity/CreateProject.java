    ...
    public void handleRequest(InputStream input, OutputStream output, Context context) throws IOException {
        ...
        try {
        	...
        	if (company != null) {
        		...
        		Contact contact = (Contact)h.getItemById(Contact.class, toIntExact((long)  body.get("contactID")));
        		if (contact != null) {
        			...
        			errorCode.put("errorCode", -17);
                    errorCode.put("message", Error.getErrorByCode(-17));
        		}
        	}else{
