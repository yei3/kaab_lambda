...
public class GetLocationAddressesByFilters implements RequestStreamHandler {

    @Override
    public void handleRequest(InputStream input, OutputStream output, Context context) throws IOException {
    	LambdaLogger logger = context.getLogger();
        logger.log("Getlocationaddressesbyfilters starting");
        ...
        try {
        	...
        	if (event.get("multiValueQueryStringParameters") != null) {
                ...
                if ( pps.get("column") != null && pps.get("condition") != null && pps.get("value") != null) {
                	...
                	if (columns.size() == conditions.size() && columns.size() == values.size()) {
                    	...
                    	List<Object> locationAddresss = (List<Object>)h.getListByConditions(LocationAddress.class, columnsString, conditionsString, valuesString);
	        ...
	        responseBody.put("locationAddresses", list);
        } catch(Exception ex) {
