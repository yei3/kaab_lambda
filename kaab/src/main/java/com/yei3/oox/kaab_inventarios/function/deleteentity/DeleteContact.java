...
public class DeleteContact implements RequestStreamHandler {

    @Override
    public void handleRequest(InputStream input, OutputStream output, Context context) throws IOException {
    	LambdaLogger logger = context.getLogger();
        logger.log("Deletecontact starting");
        ...
        try {
        	...
        	if (contact != null) {
            	...
            	//TODO add cognito >:v
            	contact.setDeleteUserID(toIntExact((long)body.get("userId")));
            	contact.setDeleteDateTime(new Timestamp(System.currentTimeMillis()));
