...
public class GetRegistrationSessionById implements RequestStreamHandler {

    @Override
    public void handleRequest(InputStream input, OutputStream output, Context context) throws IOException {
    	LambdaLogger logger = context.getLogger();
        logger.log("Getregistrationsessionbyid starting");
        ...
        try {
        	...
        	if (event.get("queryStringParameters") != null) {
                ...
                if ( pps.get("id") != null) {
                	...
                	RegistrationSession registrationSession = (RegistrationSession)h.getItemById(RegistrationSession.class,Integer.parseInt((String) pps.get("id")));
                	
                	 if (registrationSession != null) {
                		 JSONObject registrationSessionJson = new JSONObject();
                        ...
                        responseBody.put("registrationSession", registrationSessionJson);
                	 }else {
                		 errorCode.put("errorCode", 1);
                         errorCode.put("message", "The registration session corresponding to id = " + pps.get("id") + " does not exists.");
                	 }
