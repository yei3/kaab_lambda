...
public class GetLocationAddressById implements RequestStreamHandler {

    @Override
    public void handleRequest(InputStream input, OutputStream output, Context context) throws IOException {
    	LambdaLogger logger = context.getLogger();
        logger.log("Getlocationaddressbyid starting");
        ...
        try {
        	...
        	if (event.get("queryStringParameters") != null) {
                ...
                if ( pps.get("id") != null) {
                	...
                	LocationAddress locationAddress = (LocationAddress)h.getItemById(LocationAddress.class,Integer.parseInt((String) pps.get("id")));
                	
                	 if (locationAddress != null) {
                		 JSONObject locationAddressJson = new JSONObject();
                        ...
                        responseBody.put("locationAddress", locationAddressJson);
                	 }else {
                		 errorCode.put("errorCode", 1);
                         errorCode.put("message", "The location address corresponding to id = " + pps.get("id") + " does not exists.");
                	 }
