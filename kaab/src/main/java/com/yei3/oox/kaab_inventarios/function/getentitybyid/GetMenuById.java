...
public class GetMenuById implements RequestStreamHandler {

    @Override
    public void handleRequest(InputStream input, OutputStream output, Context context) throws IOException {
    	LambdaLogger logger = context.getLogger();
        logger.log("Getmenubyid starting");
        ...
        try {
        	...
        	if (event.get("queryStringParameters") != null) {
                ...
                if ( pps.get("id") != null) {
                	...
                	Menu menu = (Menu)h.getItemById(Menu.class,Integer.parseInt((String) pps.get("id")));
                	 ...
                	 if (menu != null) {
                        ...
                        responseBody.put("menu", menuJson);
                	 }else {
