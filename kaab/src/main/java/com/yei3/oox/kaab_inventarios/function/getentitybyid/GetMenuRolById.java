...
public class GetMenuRolById implements RequestStreamHandler {
        ...
        try {
        	...
        	if (event.get("queryStringParameters") != null) {
                ...
                if ( pps.get("id") != null) {
                	...
                	MenuRol menu = (MenuRol)h.getItemById(MenuRol.class,Integer.parseInt((String) pps.get("id")));
                	 ...
                	 if (menu != null) {
                        ...
                        responseBody.put("menuRol", menuJson);
                	 }else {
