...
public class UpdateAddress implements RequestStreamHandler {

    @Override
    public void handleRequest(InputStream input, OutputStream output, Context context) throws IOException {
    	LambdaLogger logger = context.getLogger();
        logger.log("Updateaddress starting");
        ...
        try {
        	...
        	Address address = (Address)h.getItemById(Address.class, toIntExact((long)body.get("id")));
        	...
        	if (address != null) {
            	...
            	//TODO add cognito >:v
            	address.setLastModUserID(toIntExact((long)body.get("userId")));
            	address.setLastModDateTime(new Timestamp(System.currentTimeMillis()));
            	
            	h.updateItem(Address.class, address);
