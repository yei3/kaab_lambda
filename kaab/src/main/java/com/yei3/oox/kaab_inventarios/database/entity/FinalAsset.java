...
public class FinalAsset implements Entity{
	...
	private boolean lastRegistration;
	...
	private String TABLE = "FINAL_ASSETS";
	...
	public String toString() {
		return "FinalAsset [id=" + id + ", projectID=" + projectID + ", registrationSessionID=" + registrationSessionID
				+ ", lastRegistration=" + lastRegistration + ", keyField=" + keyField + ", asset=" + asset
